...
export const grammarIndex: Record<string, () => Promise<GrammarComponent>> = {
  ...
  [n5.he.slug]: () => import("./n5/He.vue").then(processImport),
  ...
  [n5.kara.slug]: () => import("./n5/Kara.vue").then(processImport),
  ...
  [n5.ni.slug]: () => import("./n5/Ni.vue").then(processImport),
  ...
  [n5.sukiKirai.slug]: () => import("./n5/SukiKirai.vue").then(processImport),
  [n5.tai.slug]: () => import("./n5/Tai.vue").then(processImport),
  [n5.teHaIkenai.slug]: () => import("./n5/TeHaIkenai.vue").then(processImport),
  ...
  [n5.to.slug]: () => import("./n5/To.vue").then(processImport),
  [n5.transitivityPairs.slug]: () => import("./n5/TransitivityPairs.vue").then(processImport),
  [n5.wo.slug]: () => import("./n5/Wo.vue").then(processImport),
  [n5.ya.slug]: () => import("./n5/Ya.vue").then(processImport),
  ...
  [n4.kata.slug]: () => import("./n4/Kata.vue").then(processImport),
  [n4.kenjougo.slug]: () => import("./n4/Kenjougo.vue").then(processImport),
  [n4.kotoNiSuru.slug]: () => import("./n4/KotoNiSuru.vue").then(processImport),
  ...
  [n4.niSuru.slug]: () => import("./n4/NiSuru.vue").then(processImport),
  ...
  [n4.teMo.slug]: () => import("./n4/TeMo.vue").then(processImport),
  ...
  [n4.verbMade.slug]: () => import("./n4/VerbMade.vue").then(processImport),
