  ...
  <GrammarStructure :meta="meta" :show-polite="true" @politeness-change="(value) => isPolite = value">
    ...
    <template #explanation>
      ...
      <div class="section">
        ...
        To form the plain negative of a godan verb, refer to the godan five-step chart below. Change the final syllable
        from the う row (the dictionary form) to the あ row to get the stem for the plain negative form.
        <div class="chart">
