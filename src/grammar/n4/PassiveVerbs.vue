<script setup lang="ts">
  ...
  import { passiveVerbs as meta, ba, causativeVerbs, causativePassiveVerbs, passiveSentences, potentialVerbs, volitionalVerbs } from "./metadataN4";
  ...
  const related: { slug: string, title: string }[] = [godan, ichidan, godanNonPast, ichidanNonPast, godanNegative, ichidanNegative, godanPast, ichidanPast,
    godanPastNegative, ichidanPastNegative, teVerb, imperativeVerbs, potentialVerbs, volitionalVerbs, { slug: ba.slug, title: "Conditional verb (～ば)" }, causativeVerbs, causativePassiveVerbs];
</script>
